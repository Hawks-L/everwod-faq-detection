"""Convierte documento_tecnico.md a documento_tecnico.docx con formato profesional."""
import re
...
SRC = "documento_tecnico.md"
DST = "documento_tecnico.docx"
...
def set_heading_style(para, level, size, color_hex="1F3864"):
